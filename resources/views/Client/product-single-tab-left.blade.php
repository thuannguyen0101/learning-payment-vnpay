    ...
    <main id="main-container" class="main-container">
        ...
        <div class="product-details">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <div class="product-gallery-box product-gallery-box--tab d-flex align-items-center flex-row-reverse m-b-60">
                            ...
                            <div id="gallery-zoom" class="product-image--thumb product-image--thumb-vertical pos-relative float-20-per">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="section-content section-content--border m-b-35">
                            ...
                            <a href="/shop-sidebar-grid-left" class="btn btn--icon-left btn--small btn--radius btn--transparent btn--border-green btn--border-green-hover-green font--regular text-capitalize">More Products<i class="fal fa-angle-right"></i></a>
