...
@section('title')
    Email Application - Mazer Admin Dashboard
@endsection
@section('content')
                                ...
                                <div class="list-group list-group-messages">
                                    <a href="#" class="list-group-item pt-0 active" id="inbox-menu">
                                        <div class="fonticon-wrap d-inline me-3">
                                            ...
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#envelope" />
                                            </svg>
                                            </i>
                                        </div>
                                        Inbox
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="fonticon-wrap d-inline me-3">
                                            ...
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#archive" />
                                            </svg>
                                        </div>
                                        Sent
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <div class="fonticon-wrap d-inline me-3">
                                            ...
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#pencil" />
                                            </svg>
                                        </div> Draft
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <div class="fonticon-wrap d-inline me-3">
                                            ...
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#star" />
                                            </svg>
                                        </div>
                                        Starred
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <div class="fonticon-wrap d-inline me-3">
                                            ...
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#info-circle" />
                                            </svg>
                                        </div>
                                        Spam
                                        <span
                                    ...
                                    <div class="email-action">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <span class="fonticon-wrap">
                                                            ...
                                                            <svg class="bi" width="1.5em" height="1.5em"
                                                                 fill="currentColor">
                                                                <use
                                                                    xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#folder" />
                                                            </svg>
                                                        </span>
                                                        </button>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <span class="fonticon-wrap">
                                                            ...
                                                            <svg class="bi" width="1.5em" height="1.5em"
                                                                 fill="currentColor">
                                                                <use
                                                                    xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#tag" />
                                                            </svg>
                                                        </span>
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right"
                                        ...
                                        <div
                                            ...
                                            <div class="email-fixed-search flex-grow-1">
                                                ...
                                                <div class="form-group position-relative  mb-0 has-icon-left">
                                                    ...
                                                    <div class="form-control-icon">
                                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                            <use
                                                                xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#search" />
                                                        </svg>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <button class="btn btn-icon email-pagination-prev d-none d-sm-block">
                                                <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                    <use
                                                        xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#chevron-left" />
                                                </svg>
                                            </button>
                                            <button class="btn btn-icon email-pagination-next d-none d-sm-block">
                                                <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                    <use
                                                        xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#chevron-right" />
                                                </svg>
                                            </button>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="users-list-wrapper media-list">
                                            <li class="media mail-read">
                                                <div class="user-action">
                                                    ...
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#star-fill" />
                                                    </svg>
                                                </span>
                                                </div>
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img src="asset/images/faces/1.jpg" alt="avtar img holder">
                                                    </div>
                                                </div>
                                            ...
                                            <li class="media mail-read">
                                                <div class="user-action">
                                                    ...
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="asset/vendors/bootstrap-icons/bootstrap-icons.svg#star" />
                                                    </svg>
                                                </span>
                                                </div>
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img class="rounded-circle" src="asset/images/faces/3.jpg"
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img class="rounded-circle" src="asset/images/faces/7.jpg"
                                                             alt="Generic placeholder image">
                                                    </div>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img class="rounded-circle" src="asset/images/faces/5.jpg"
                                                             alt="Generic placeholder image">
                                                    </div>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <li class="media mail-read">
                                                ...
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img class="rounded-circle" src="asset/images/faces/8.jpg"
                                                             alt="Generic placeholder image">
                                                    </div>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <li class="media mail-read">
                                                ...
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img class="rounded-circle" src="asset/images/faces/6.jpg"
                                                             alt="Generic placeholder image">
                                                    </div>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <li class="media">
                                                ...
                                                <div class="pr-50">
                                                    <div class="avatar">
                                                        <img class="rounded-circle" src="asset/images/faces/1.jpg"
                                                             alt="Generic placeholder image">
                                                    </div>
                                                </div>
                                                <div class="media-body">
                                                        ...
                                                        <div class="collapse-title media">
                                                            <div class="pr-1">
                                                                <div class="avatar mr-75">
                                                                    <img src="asset/images/faces/18.jpg"
                                                ...
                                                <div class="card collapse-header" role="tablist">
                                                    <div id="headingCollapse6"
                                                        ...
                                                        <div class="collapse-title media">
                                                            <div class="pr-1">
                                                                <div class="avatar mr-75">
                                                                    <img src="asset/images/faces/19.jpg"
                                                                         alt="avtar img holder" width="30" height="30">
                                                                </div>
                                                            </div>
                                                            <div class="media-body mt-25">
